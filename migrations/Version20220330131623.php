 ...
 */
final class Version20220330131623 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE idatelier (idatelier INT NOT NULL, idtheme INT NOT NULL, INDEX IDX_3EBF4A4D3EBF4A4D (idatelier), INDEX IDX_3EBF4A4D41708B11 (idtheme), PRIMARY KEY(idatelier, idtheme)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE idatelier ADD CONSTRAINT FK_3EBF4A4D3EBF4A4D FOREIGN KEY (idatelier) REFERENCES atelier (id)');
        $this->addSql('ALTER TABLE idatelier ADD CONSTRAINT FK_3EBF4A4D41708B11 FOREIGN KEY (idtheme) REFERENCES theme (id)');
