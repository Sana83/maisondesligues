...
final class Version20220330132322 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE idatelier (atelier_id INT NOT NULL, theme_id INT NOT NULL, INDEX IDX_3EBF4A4D82E2CF35 (atelier_id), INDEX IDX_3EBF4A4D59027487 (theme_id), PRIMARY KEY(atelier_id, theme_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
