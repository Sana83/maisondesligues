 ...
 */
final class Version20220330121909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vacation CHANGE atelier_id idatelier INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vacation CHANGE idatelier atelier_id INT NOT NULL');
