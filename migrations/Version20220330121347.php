 ...
 */
final class Version20220330121347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nuite CHANGE date_nuitee dateNuitee DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nuite CHANGE dateNuitee date_nuitee DATETIME NOT NULL');
