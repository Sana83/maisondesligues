 ...
 */
final class Version20220330135540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE atelierTheme (idatelier INT NOT NULL, idtheme INT NOT NULL, INDEX IDX_CB1631F43EBF4A4D (idatelier), INDEX IDX_CB1631F441708B11 (idtheme), PRIMARY KEY(idatelier, idtheme)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE atelierTheme ADD CONSTRAINT FK_CB1631F43EBF4A4D FOREIGN KEY (idatelier) REFERENCES atelier (id)');
        $this->addSql('ALTER TABLE atelierTheme ADD CONSTRAINT FK_CB1631F441708B11 FOREIGN KEY (idtheme) REFERENCES theme (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE atelierTheme');
