...
class SecurityController extends AbstractController
{
    ...
    public function oubliPass(Request $request, UserRepository $users, \Swift_Mailer $mailer, TokenGeneratorInterface $tokenGenerator): Response
    {
        ...
        $message = (new \Swift_Message('Mot de passe oublié'))
            ...
            ->setTo($user->getEmail())
            ->setBody(
                "<p>Bonjour,</p><p>Une demande de réinitialisation de mot de passe a été effectuée pour le site Maison Des Ligues. Veuillez cliquer sur le lien suivant : " . $url. '</p>',
                'text/html'
            )
        ;
